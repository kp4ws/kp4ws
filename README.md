...
## 🔭 Current Focus
- Building full-stack and systems-driven applications from the ground up  
- Exploring graphics programming and simulation (terrain, erosion, real-time rendering)  
- Strengthening problem-solving through data structures and algorithms  
- Writing clean, maintainable code with strong system design principles 
